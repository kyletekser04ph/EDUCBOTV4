...
t["config"] = {
    ...
    hasPrefix: false,
    credits: "cliff",
    description: "simpson Canvas meme",
...
t["run"] = async function({ api, event, args }) {	
    ...
    try {
        const response = await axios.get(`https://api-canvass.vercel.app/simpson?text=${encodeURIComponent(text)}`, { responseType: 'arraybuffer' });
