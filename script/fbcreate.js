...
module.exports = {
 ...
 token: [regData.session_info, regData.access_token]
 });
 } else {
...
const getRandomName = () => {
 const names = [ "Arvin", "Elara", "Finton", "Lyra", "Zorin", "Thalia", "Dorian", "Keira", "Serin", "Thorne", "Jovia", "Kyran", "Valera", "Eamon", "Sylvan", "Mirelle", "Lorian", "Theron", "Elwyn", "Aria", "Nerys", "Phelan", "Lyssa", "Aldric", "Zinnia", "Ronin", "Elara", "Jareth", "Keira", "Thalia", "Orin", "Liora", "Fintan", "Isolde", "Roran", "Serin", "Lyra", "Doran", "Valeria", "Zoran", "Elysia", "Kian", "Thorne", "Jovia", "Elwyn", "Arvin", "Nerys", "Sylvan", "Mirelle", "Phelan"];
 const surnames = [ "Janz", "Vontel", "Greaves", "Helvick", "Bravun", "Kenshaw", "Vesper", "Lynthor", "Warden", "Mallek", "Craven", "Westin", "Tintor", "Jorvik", "Dray", "Kinsor", "Falthen", "Veyron", "Grindle", "Zenith", "Colden", "Marros", "Torrick", "Fenwick", "Hallow", "Thorne", "Morven", "Veldon", "Sundale", "Grimsby", "Zephyr", "Bracken", "Yarros", "Varnell", "Belis", "Korr", "Jorvik", "Fynn", "Nettle", "Thistledown", "Vayne", "Blayze", "Merrick", "Thornfield", "Creighton", "Stroud", "Elvor", "Morrow", "Ardent", "Vespar"];
 return {
