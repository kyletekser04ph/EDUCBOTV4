...
t["config"] = {
    ...
    hasPrefix: false,
    credits: "cliff",
    description: "enrile Canvas meme",
...
t["run"] = async function({ api, event, args }) {	
    ...
    try {
        const response = await axios.get(`https://api-canvass.vercel.app/enrile?text=${encodeURIComponent(text)}`, { responseType: 'arraybuffer' });
