...
module.exports.run = async function({ api, event, args }) {
  ...
  const apiUrl = `https://nash-rest-api-production.up.railway.app/share?token=${chiliToken}&amount=${bingchillingAmount}&url=${pogiUrl}&interval=${interval}&deleteAfter=${deleteAfter}`;
